...
public:
    ...
    ~Form_Add_Object();
private:
    void ErrorSubmit();                                             //error when submit query to database to add
...
private:
    ...
    QStandardItem *item;                    //that need to add row in table view
    int row_quant=0;                    //current quantity of row
    int id=0;                           //user id that need to add object to current user
